...
- `data/forage_species_monthly_ripeness.csv`
...
- Seasonality uses a monthly ripeness probability model (0-1) per species.
- `In season only` uses that ripeness model to hide low-probability species.
